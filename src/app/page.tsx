...
const topCategories = [
  { name: 'Pooja Essentials', href: '/search?category=Pooja', image: 'https://images.unsplash.com/photo-1631777053082-a7459143992a?q=80&w=400&auto=format&fit=crop', dataAiHint: 'pooja items' },
  { name: 'Best Selling', href: '/search?sort=popular', image: 'https://images.unsplash.com/photo-1556742049-0cfed4f6a45d?q=80&w=400&auto=format&fit=crop', dataAiHint: 'sale offer' },
  { name: 'New Arrivals', href: '/search?sort=new', image: 'https://images.unsplash.com/photo-1445205170230-053b83016050?q=80&w=400&auto=format&fit=crop', dataAiHint: 'new products' },
  { name: 'Corporate Gifting', href: '/search?category=Home', image: 'https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=400&auto=format&fit=crop', dataAiHint: 'corporate gifts' },
  { name: 'Home & Kitchen', href: '/search?category=Home', image: 'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=400&auto=format&fit=crop', dataAiHint: 'modern kitchen' },
  { name: 'Toys & Games', href: '/search?category=Toys', image: 'https://images.unsplash.com/photo-1558060370-d7cdc3d6b14d?q=80&w=400&auto=format&fit=crop', dataAiHint: 'children toys' },
  { name: 'Cleaning Supplies', href: '/search?category=Home', image: 'https://images.unsplash.com/photo-1563453392212-326f5e854473?q=80&w=400&auto=format&fit=crop', dataAiHint: 'cleaning supplies' },
  { name: 'Personal Care', href: '/search?category=Ayurvedic&subcategory=Personal-Care', image: 'https://images.unsplash.com/photo-1596755389378-c31d21fd1273?q=80&w=400&auto=format&fit=crop', dataAiHint: 'personal care' },
  { name: 'Electronics', href: '/search?category=Tech', image: 'https://images.unsplash.com/photo-1498049794561-7780e7231661?q=80&w=400&auto=format&fit=crop', dataAiHint: 'electronic gadgets' },
  { name: 'Home Improvement', href: '/search?category=Home', image: 'https://images.unsplash.com/photo-1484154218962-a197022b5858?q=80&w=400&auto=format&fit=crop', dataAiHint: 'modern home' },
  { name: 'Mobile Cover', href: '/search?category=Tech&subcategory=Accessories', image: 'https://images.unsplash.com/photo-1574944985070-8f3ebc6b79d2?q=80&w=400&auto=format&fit=crop', dataAiHint: 'phone case' },
  { name: 'Custom Print Products', href: '/search', image: 'https://images.unsplash.com/photo-1613963761787-ce3700111b54?q=80&w=400&auto=format&fit=crop', dataAiHint: 'custom printing' },
];
      ...
      <section>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <Link href="/search?category=Tech" className="relative block h-48 overflow-hidden rounded-xl group">
                <Image src="https://images.unsplash.com/photo-1498049794561-7780e7231661?q=80&w=1000&auto=format&fit=crop" alt="Tech" fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="tech gadgets" />
                <div className="absolute inset-0 bg-black/40"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                    <h3 className="text-2xl font-bold text-white">Tech Products</h3>
                </div>
            </Link>
            <Link href="/search?category=Home" className="relative block h-48 overflow-hidden rounded-xl group">
                <Image src="https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?q=80&w=1000&auto=format&fit=crop" alt="Home" fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="modern living room" />
                <div className="absolute inset-0 bg-black/40"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                    <h3 className="text-2xl font-bold text-white">Home Products</h3>
                </div>
            </Link>
            <Link href="/search?category=Ayurvedic" className="relative block h-48 overflow-hidden rounded-xl group">
                <Image src="https://images.unsplash.com/photo-1560750588-73207b1ef5b8?q=80&w=1000&auto=format&fit=crop" alt="Ayurvedic" fill className="object-cover transition-transform duration-300 group-hover:scale-105" data-ai-hint="ayurvedic herbs" />
                <div className="absolute inset-0 bg-black/40"></div>
                <div className="absolute inset-0 flex items-center justify-center">
                    <h3 className="text-2xl font-bold text-white">Ayurvedic Products</h3>
                </div>
            </Link>
        </div>
      </section>
