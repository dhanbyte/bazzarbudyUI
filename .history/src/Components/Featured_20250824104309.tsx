...
const FeaturedBundles = () => {
  ...
  const techBundles = bundles.filter(bundle => bundle.category === 'tech');
            ...
            >
              ...
              <div className="p-5">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button className="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-semibold shadow">
                    Add to Cart
                  </button>
                </div>
              </div>
